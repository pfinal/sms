 ...
 *      $sms->accountSid = '7524722244217bbbfb78bf6901c826';
 *      $sms->token = '42035677747cf79a1d06f73ac3ef0e99';
 *      $sms->appId = "cb1fbb734d8888e85db04fc908f6";
 *      $sms->templateId = 13887;
 *      return $sms;
 * };
 *
 * 发手机验证码
 ...
 * @since   1.0
 */
class UcpaasSMS implements SmsVerifyInterface, SmsTemplateInterface
{
    public $accountSid;
    public $token;
    public $appId;
    ...
    {
        return $this->templateSMS($phone, $this->templateId, "$code", $error);
    }

    /**
     * 发短信
     *
     * 模板: 尊敬的用户你好，截止{1}您的帐户金额为{2}元，低于您设置的{3}元提醒值，请及时充值
     * $templateId = "2";
     * $param="aaa,bbb,ccc";
     * 发送内容: 尊敬的用户你好，截止aaa您的帐户金额为bbb元，低于您设置的ccc元提醒值，请及时充值
     *
     * @param string $phone
    ...
    public function templateSMS($phone, $templateId = null, $param = '', &$error = null)
    {
        ...
        try {
            $response = $ucpass->templateSMS($this->appId, $phone, $templateId, $param);

            //成功返回
            //{"resp":{"respCode":"000000","templateSMS":{"createDate":"20141228113525","smsId":"1c574de11407b03ea6306aae745f6d1d"}}}
            //错误返回
            //{"resp":{"respCode":"105112"}}
            $arr = json_decode($response, true);
            if (is_array($arr) && isset($arr['resp']['respCode']) && $arr['resp']['respCode'] == '000000') {
                return true;
            }
        } catch (\Exception $ex) {
